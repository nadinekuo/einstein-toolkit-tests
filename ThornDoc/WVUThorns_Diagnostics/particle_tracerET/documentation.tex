...
%    \begin{figure}[ht]
% 	\begin{center}
%    	   \includegraphics[width=6cm]{/home/runner/work/einstein-toolkit-tests/einstein-toolkit-tests/arrangements/WVUThorns_Diagnostics/particle_tracerET/doc/MyArrangement_MyThorn_MyFigure}
% 	\end{center}
