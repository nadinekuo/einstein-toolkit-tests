...
%    \begin{figure}[ht]
% 	\begin{center}
%    	   \includegraphics[width=6cm]{/home/runner/work/einstein-toolkit-tests/einstein-toolkit-tests/arrangements/ExternalLibraries/OpenBLAS/doc/MyArrangement_MyThorn_MyFigure}
% 	\end{center}
...
\begin{abstract}
This thorn provides access to the OpenBLAS library.
\end{abstract}
