...
%    \begin{figure}[ht]
% 	\begin{center}
%    	   \includegraphics[width=6cm]{/home/runner/work/einstein-toolkit-tests/einstein-toolkit-tests/arrangements/ExternalLibraries/PETSc/doc/MyArrangement_MyThorn_MyFigure}
% 	\end{center}
...
\begin{abstract}
This thorn provides access to the PETSc library.
\end{abstract}
