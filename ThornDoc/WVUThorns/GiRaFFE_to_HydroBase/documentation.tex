...
%    \begin{figure}[ht]
%       \begin{center}
%          \includegraphics[width=6cm]{/home/runner/work/einstein-toolkit-tests/einstein-toolkit-tests/arrangements/WVUThorns/GiRaFFE_to_HydroBase/doc/MyArrangement_MyThorn_MyFigure}
%       \end{center}
...
\begin{abstract}
{\tt GiRaFFE} and {\tt HydroBase} variables are incompatible;
...
"$W^i$", and {\tt GiRaFFE}'s definition "$v^i$"
Then
\begin{equation}
W^i = (v^i + \beta^i) / (\alpha),
\end{equation}
which comes from Eq 11 in the {\tt GiRaFFE} code announcement
