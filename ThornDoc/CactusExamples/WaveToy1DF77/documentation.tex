...
%    \begin{figure}[ht]
% 	\begin{center}
%    	   \includegraphics[width=6cm]{/home/runner/work/einstein-toolkit-tests/einstein-toolkit-tests/arrangements/CactusExamples/WaveToy1DF77/doc/MyArrangement_MyThorn_MyFigure}
% 	\end{center}
