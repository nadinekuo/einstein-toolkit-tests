...
%    \begin{figure}[ht]
% 	\begin{center}
%    	   \includegraphics[width=6cm]{/home/runner/work/einstein-toolkit-tests/einstein-toolkit-tests/arrangements/Carpet/CarpetIOBasic/doc/MyArrangement_MyThorn_MyFigure}
% 	\end{center}
