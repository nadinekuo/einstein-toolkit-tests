...
%    \begin{figure}[ht]
% 	\begin{center}
%    	   \includegraphics[width=6cm]{/home/runner/work/einstein-toolkit-tests/einstein-toolkit-tests/arrangements/CactusNumerical/SphericalSurface/doc/MyArrangement_MyThorn_MyFigure}
% 	\end{center}
