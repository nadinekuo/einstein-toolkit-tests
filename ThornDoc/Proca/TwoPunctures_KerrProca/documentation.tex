...
%    \begin{figure}[ht]
% 	\begin{center}
%    	   \includegraphics[width=6cm]{/home/runner/work/einstein-toolkit-tests/einstein-toolkit-tests/arrangements/Proca/TwoPunctures_KerrProca/doc/MyArrangement_MyThorn_MyFigure}
% 	\end{center}
