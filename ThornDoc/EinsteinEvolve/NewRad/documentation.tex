...
%    \begin{figure}[ht]
% 	\begin{center}
%    	   \includegraphics[width=6cm]{/home/runner/work/einstein-toolkit-tests/einstein-toolkit-tests/arrangements/EinsteinEvolve/NewRad/doc/MyArrangement_MyThorn_MyFigure}
% 	\end{center}
...
\author{Roland Haas {\textless}rhaas@ncsa.illinois.edu{\textgreater}}
