...
%    \begin{figure}[ht]
% 	\begin{center}
%    	   \includegraphics[width=6cm]{/home/runner/work/einstein-toolkit-tests/einstein-toolkit-tests/arrangements/EinsteinInitialData/FLRWSolver/doc/MyArrangement_MyThorn_MyFigure}
% 	\end{center}
...
um\_file"} \\\multicolumn{1}{|p{\maxVarWidth}|}{\centering fileread} & \multicolumn{2}{p{\paraWidth}|}{Linear perturbations to FLRW in longitudinal gauge -- read in from supplied ascii files (specific format - see doc)} \\\hline
\end{tabular*}
